...
Invoke-RestMethod "https://raw.githubusercontent.com/NovofermNL/Publics/main/Prod/OSDCloud/OSUpdate.ps1" | Out-File -FilePath 'C:\Windows\Setup\scripts\OSUpdate.ps1' -Encoding ascii -Force
