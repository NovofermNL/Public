<#
    ...
    Verwijder ingebouwde apps (moderne apps) van Windows 11 voor alle gebruikers.
#>
...
Begin {
    ...
    $BlackListedAppsURL = "https://raw.githubusercontent.com/NovofermNL/Public/refs/heads/main/Prod/OSDCloud/Imaging/AppsBlacklist.txt"
